...
shinyUI(
  tagList(
    ...
    tags$head(tags$style(".shiny-notification {position: fixed; top: 30% ;left: 50%")),
    tags$style(HTML("
      ...
      tabPanel(
        ...
        div(
          ...
          #     # align = 'center',
              fileInput(
                "rDataFile",
                label = NULL,#"Select Project file",
