...
#' This defualts to database/project.sqlite and is not expected to change
...
#' @param db_path The location of the project databse. This defualts to database/project.sqlite and is not expected to change
...
#' @param query A valid SQL Query
#' @param db_path The location of the main databse. This defualts to database/plethemdb.sqlite and is not expected to change
#' This function will not be called by the user directly
#' @export
...
#' @param query A valid SQL Query
#' @param db_path The location of the project databse. This defualts to database/plethemdb.sqlite and is not expected to change
#' This function will not be called by the user directly
#' @export
